...
export function OnboardingFooter({
  ...
  return (
    <div className="mt-10 fixed inset-x-0 bottom-0 z-50 border-t border-border/20 bg-background/90 backdrop-blur-lg md:static md:z-auto md:border-0 md:bg-transparent md:backdrop-blur-none">

...
export function DroppedShipsBlock({ title: _title }: { title: string }): React.JSX.Element | null {
    ...
    <section className="-mx-5 md:-mx-8 lg:mx-0">
      <div className="px-4 md:px-8 lg:px-0">
        <p className="text-sm font-medium text-muted-foreground">
          {count === 1 ? "One ship didn't survive the voyage" : `${count} ships didn't survive the voyage`}
        </p>
        <p className="text-lg font-semibold text-foreground">Set adrift</p>
      </div>

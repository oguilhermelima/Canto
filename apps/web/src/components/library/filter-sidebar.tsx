  ...
  return (
    <div className={className}>
      ...
      <Button
        variant="outline"
        size="sm"
        className="mb-4 gap-2 border-border text-foreground"
        onClick={onToggle}
      >
...
function FilterPill({
  ...
  return (
    <span className="inline-flex items-center gap-1 rounded-full bg-muted px-2.5 py-1 pr-1 text-xs font-medium text-foreground">
      {label}
      <button
        onClick={onRemove}

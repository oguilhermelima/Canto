...
export function NewCollectionCard(): React.JSX.Element {
  return (
    <Link
      ...
      className="group relative flex w-[300px] shrink-0 overflow-hidden rounded-2xl border border-dashed border-border transition-colors duration-200 hover:border-foreground hover:bg-muted/30 sm:w-[340px] lg:w-[380px] 2xl:w-[420px]"
    >

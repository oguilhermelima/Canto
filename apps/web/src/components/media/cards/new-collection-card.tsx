...
export function NewCollectionCard(): React.JSX.Element {
  return (
    <Link
      ...
      className="group relative flex w-[260px] shrink-0 overflow-hidden rounded-xl border border-dashed border-border transition-colors duration-200 hover:border-foreground hover:bg-muted/30 sm:w-[280px] lg:w-[300px]"
    >
